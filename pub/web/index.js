...
// end include: /tmp/tmp7_grybnc.js
...
var ASM_CONSTS = {
  44224: () => { if (document.fullscreenElement) return 1; },  
 44270: () => { return document.getElementById('canvas').width; },  
 44322: () => { return parseInt(document.getElementById('canvas').style.width); },  
 44390: () => { document.exitFullscreen(); },  
 44417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 44490: () => { if (document.fullscreenElement) return 1; },  
 44536: () => { return document.getElementById('canvas').width; },  
 44588: () => { return screen.width; },  
 44613: () => { document.exitFullscreen(); },  
 44640: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 44773: () => { if (document.fullscreenElement) return 1; },  
 44819: () => { return document.getElementById('canvas').width; },  
 44871: () => { return parseInt(document.getElementById('canvas').style.width); },  
 44939: () => { if (document.fullscreenElement) return 1; },  
 44985: () => { return document.getElementById('canvas').width; },  
 45037: () => { return screen.width; },  
 45062: () => { if (document.fullscreenElement) return 1; },  
 45108: () => { return document.getElementById('canvas').width; },  
 45160: () => { return screen.width; },  
 45185: () => { document.exitFullscreen(); },  
 45212: () => { if (document.fullscreenElement) return 1; },  
 45258: () => { return document.getElementById('canvas').width; },  
 45310: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45378: () => { document.exitFullscreen(); },  
 45405: () => { return screen.width; },  
 45430: () => { return screen.height; },  
 45456: () => { return window.screenX; },  
 45483: () => { return window.screenY; },  
 45510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 45563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 45634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 45691: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 45762: () => { if (document.fullscreenElement) return 1; },  
 45808: () => { if (document.pointerLockElement) return 1; },  
 45855: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 48013: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 48177: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 48281: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 51280: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 51346: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 51739: ($0) => { miniaudio.untrack_device_by_index($0); },  
 51782: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 51907: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
...
var ___start_em_js = Module['___start_em_js'] = 52033;
var ___stop_em_js = Module['___stop_em_js'] = 52106;
